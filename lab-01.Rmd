...
**NA means not available and this is because some values don't exist so a comprehensive average
...
Main attractions pull in much bigger numbers so pulling the mean up while the mid point is still relatively low
...
Not reliable becuase not enough data for some countries 
